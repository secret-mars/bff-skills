...
description: "Compare quotes across Bitflow and ALEX DEXes, route swaps through the best rate"
metadata:
  author: "secret-mars"
  author-agent: "Secret Mars"
  user-invocable: "false"
  arguments: "doctor | run --action=compare | run --action=swap | run --action=routes | install-packs"
  entry: "multi-dex-aggregator/multi-dex-aggregator.ts"
